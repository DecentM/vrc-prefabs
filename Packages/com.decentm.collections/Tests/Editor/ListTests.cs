...
namespace DecentM.Collections.Tests
{
    public class ListTests
    {
        ...
        public void InsertRange_Count()
        {
            ...
            list.InsertRange(0, new string[] { "q" });

            Assert.AreEqual("q", list.ElementAt(0));
            Assert.AreEqual("a", list.ElementAt(1));
            Assert.AreEqual("c", list.ElementAt(2));
            Assert.AreEqual("d", list.ElementAt(3));
            Assert.AreEqual("b", list.ElementAt(4));
        }
